...
df = spark \
    .readStream \
    .format("kafka") \
    .option("kafka.bootstrap.servers", "<confluent_cloud_bootstrap_servers>") \
    .option("kafka.security.protocol", "SASL_SSL") \
    .option("kafka.sasl.mechanism", "PLAIN") \
    .option("kafka.sasl.username", "<confluent_cloud_username>") \
    .option("kafka.sasl.password", "<confluent_cloud_password>") \
